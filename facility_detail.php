...
<body>
    ...
    <div class="facility-detail-container">
        <div class="detail-section">
            ...
            <?php if (!empty(trim($facility['description']))): ?>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="readonly-field">
                    <?= htmlspecialchars($facility['sns_account']) ?>
                </div>
            </div>
            <?php endif; ?>
